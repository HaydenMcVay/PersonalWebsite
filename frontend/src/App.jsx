...
const projects = [
  ...
  {
    title: "Web URL Shortener",
    description: "Shortens URLs through my own website, built with Node.js and Express.",
    tag: "Web / API",
  },
  {
            ...
            {projects.map((project) => (
              <div key={project.title} className={`rounded-3xl p-6 transition hover:-translate-y-1 hover:bg-white/[0.07] ${themeStyles.softCard}`}>
                ...
                {project.title !== "Interactive Portfolio" && (
                  <button className={`mt-6 inline-flex items-center gap-2 text-sm font-medium ${accentStyles.accentButton}`}>
